...
MULTI_PINYIN_EXAMPLES: dict[str, dict[str, str]] = {
    ...
    "待": {"dāi": "待会儿，停留一会儿", "dài": "等待/对待，等候或对待"},
    ...
    "削": {"xiāo": "削铅笔，用刀去掉外皮", "xuē": "削弱/剥削，减少或压迫"},
    ...
    "冠": {"guān": "鸡冠/衣冠，帽子或顶上的东西", "guàn": "冠军，第一名"},
    "任": {"rèn": "任务/责任，担任或承担", "rén": "任丘，姓氏/地名读音"},
    ...
    "折": {"zhé": "打折/折断，弯或断", "zhē": "折腾，翻来覆去", "shé": "折本，亏损"},
    "钉": {"dīng": "钉子，铁钉（名词）", "dìng": "钉钉子（动词）"},
    "闷": {"mēn": "闷热，不透气", "mèn": "烦闷/纳闷，不高兴"},
    "把": {"bǎ": "把门关上，介词/动词", "bà": "刀把儿，把手（名词）"},
    "塞": {"sāi": "塞住，堵上（口语）", "sài": "边塞/塞外，关口", "sè": "堵塞/阻塞（书面）"},
    "冲": {"chōng": "冲水/冲锋，快速向前", "chòng": "冲着，对着/朝着"},
    "系": {"xì": "关系/联系，连接", "jì": "系鞋带/系围巾（动词）"},
    "率": {"lǜ": "效率/比率，比例", "shuài": "率领/率先，带头"},
    "横": {"héng": "横线/横着，水平方向", "hèng": "蛮横/横财，不讲理"},
    "丧": {"sāng": "丧事/奔丧，跟死亡有关", "sàng": "丧失/丧气，失去"},
    "劲": {"jìn": "干劲/使劲，力气", "jìng": "强劲/劲敌，有力"},
    "禁": {"jīn": "禁不住/不禁，忍不住", "jìn": "禁止/禁令，不允许"},
    "吐": {"tǔ": "吐痰/吐出来（主动）", "tù": "呕吐，恶心想吐（被动）"},
    "哄": {"hǒng": "哄骗/哄人，欺骗", "hōng": "哄堂大笑，一起笑", "hòng": "起哄，捣乱"},
    "称": {"chēng": "称呼/名称，叫做", "chèn": "称心/对称，合适"},
    "笼": {"lóng": "鸟笼/笼子（名词）", "lǒng": "笼罩/笼统，覆盖"},
    "哼": {"hēng": "哼歌，鼻子发声", "hng": "哼，不满意或不相信的语气词"},
    "露": {"lù": "露水/暴露（书面）", "lòu": "露出来/露馅（口语）"},
    "荷": {"hé": "荷花，莲花", "hè": "荷锄，扛着/背负"},
    "角": {"jiǎo": "角落/三角/牛角", "jué": "角色/角斗，扮演"},
    "当": {"dāng": "当时/当然/应当", "dàng": "当铺/上当，受骗"},
    "乘": {"chéng": "乘车/乘法，搭乘", "shèng": "千乘之国（古文量词）"},
    "强": {"qiáng": "强大/坚强，力量大", "qiǎng": "勉强/强迫，硬要", "jiàng": "倔强，固执"},
    "将": {"jiāng": "将来/将要，快要", "jiàng": "将军/大将，军官"},
    "正": {"zhèng": "正确/正好，不偏", "zhēng": "正月，农历一月"},
    "答": {"dá": "回答/答案，回应", "dā": "答应/答理，同意"},
    "更": {"gēng": "更夫/三更，旧时夜间计时", "gèng": "更加，程度加深"},
    "落": {"luò": "落叶/降落（书面）", "là": "丢三落四，遗落（口语）", "lào": "落枕"},
    "悄": {"qiāo": "悄悄，声音很轻", "qiǎo": "悄然/悄寂，安静无声"},
    "要": {"yào": "重要/需要/要求", "yāo": "要求（正式读音）"},
    "会": {"huì": "开会/学会，能够", "kuài": "会计，算账的"},
    "给": {"gěi": "给你/给他（口语）", "jǐ": "供给/给予（书面）"},
    "燕": {"yàn": "燕子，一种鸟", "yān": "燕国/燕山（地名）"},
    "识": {"shí": "认识/识字，知道辨认", "zhì": "博闻强识，记住"},
    "卷": {"juǎn": "卷起，把东西弯转", "juàn": "试卷/书卷，成册或纸张"},
}
